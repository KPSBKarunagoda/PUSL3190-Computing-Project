...
def train_and_save_model():
    ...
    model_path = os.path.join(current_dir, 'url_model_v4.pkl')
    scaler_path = os.path.join(current_dir, 'scaler_v4.pkl')
    dump(model, model_path)
    dump(scaler, scaler_path)
    dump(FEATURE_NAMES, os.path.join(current_dir, 'feature_names.pkl'))
