...
CREATE TABLE `blacklist` (
  ...
  `RiskLevel` int(11) NOT NULL DEFAULT 100,
  `is_system` tinyint(1) DEFAULT 0,
  PRIMARY KEY (`BlacklistID`),
  UNIQUE KEY `idx_blacklist_url` (`URL`),
  KEY `AddedBy` (`AddedBy`),
...
CREATE TABLE `educationalcontent` (
  ...
  KEY `educationalcontent_ibfk_2` (`BlacklistID`),
...
-- Note: This uses a pre-generated bcrypt hash to access the admin panel of the system
